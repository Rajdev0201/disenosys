...
//   return (
//     <div className="container mx-auto font-garet">
...
//             <h1 className="font-bold text-center text-gray-700  text-base">Welcome!</h1>
...
//               <button
//                 type="submit"
//                 className="bg-[#182073] w-full p-4 mt-5 text-xl  font-semibold text-white rounded-md"
//               >
//                 Register Now
//               </button>
//               <h1
