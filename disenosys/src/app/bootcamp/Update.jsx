  ...
  return (
    <div className="bg-white">
      ...
      <h1 className="text-5xl font-bold text-center">
        Skyrocket Your <span className="text-[#182073]">LinkedIn Growth</span>{" "}
        in 5 Days
      </h1>
      <h4 className="text-xl mt-6 font-medium text-center">
        Build a personal brand, generate high-ticket leads & get inbound job
        offers
      </h4>
      </div>
      <div className="flex flex-row px-44 gap-12 mx-auto -mt-10">
        <div className="flex flex-col justify-center items-center border-2 border-gray-200 rounded-xl shadow-inner">
          <div className="flex flex-row p-6 ">
            ...
            <div className=" text-[#182073] sm:px-2 lg:px-2 py-2 flex items-center gap-2 rounded">
        ...
        <div className="px-2">
           ...
           <div className="flex flex-col justify-center -mt-10 absolute px-2 py-1 ml-10 items-center w-44 bg-blue-100 rounded-lg shadow-inner">
      ...
      <div className="mt-28">
          {/* <h1 className="text-center text-5xl font-bold">What industry&apos;s biggest creators have to say</h1> */}
          <Testimonials/>
      </div>
      ...
      <div className="mt-20">
        <div className="bg-world py-80 rounded-2xl shadow-xl text-center">
            ...
            <div className="flex justify-center items-center gap-5 mt-44">
               <div className="flex justify-center items-center gap-2 px-2 py-1 bg-white rounded-md shadow-md">
               <FaGraduationCap className="w-10 h-10 text-[#182073]" />
                 <h4> <span className="text-2xl font-bold font-poppins text-[#182073]">150K+</span> Learners</h4>
               </div>
               <div className="flex justify-center items-center gap-2 px-2 py-1 bg-white rounded-md shadow-md">
               <TbWorld 
               className="w-10 h-10 text-[#182073]" />
                 <h4> <span className="text-2xl font-bold font-poppins text-[#182073]">30K+</span> Countries</h4>
               </div>
               <div className="flex justify-center items-center gap-2 px-2 py-1 bg-white rounded-md shadow-md">
               <MdStars className="w-10 h-10 text-[#182073]" />
                 <h4> <span className="text-2xl font-bold font-poppins text-[#182073]">4.76/5</span> Ratings </h4>
               </div>
            </div>
        </div>
      </div>
