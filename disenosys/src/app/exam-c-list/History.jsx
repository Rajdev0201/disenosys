...
const MyCourse = () => {
  ...
  const course = useSelector((state) => state.exam);
  console.log(course)
          ...
          <table className="min-w-full bg-white border border-gray-200">
            <thead className="bg-slate-200 border-b border-gray-300 text-[#182073]">
              <tr>
                ...
                <th className="py-3 px-4 text-center border-r border-[#182073]">Score</th>
  ...
  {paginatedData?.map((item, index) => {
    return (
      <tr key={item._id} className="border-b border-gray-200">
        ...
        <td className="py-3 px-4 text-center text-gray-400">{item.score}</td>
