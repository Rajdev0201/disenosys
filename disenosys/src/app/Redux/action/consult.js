...
export const CheckOut = (Data, nav) => async (dispatch) => {
    try {
        ...
        const res = await axios.post("http://localhost:8000/consult/checkout-order", {
        ...
        const options = {
            ...
            handler: async (response) => {
                try {
                    ...
                    const captureResponse = await axios.post("http://localhost:8000/consult/handle-razorpay-callback", {
...
export const payment = () => async (dispatch) => {
    try {
        const res = await axios.get("http://localhost:8000/consult/getPlaceOrder");
