...
export const CheckOut = (Data, nav) => async (dispatch) => {
    try {
        ...
        const res = await axios.post("https://disenosys-dkhj.onrender.com/bootcamp/checkout-order", {
        ...
        const options = {
            ...
            handler: async (response) => {
                try {
                    ...
                    const captureResponse = await axios.post("https://disenosys-dkhj.onrender.com/bootcamp/handle-razorpay-callback", {
...
export const payment = () => async (dispatch) => {
    try {
        const res = await axios.get("https://disenosys-dkhj.onrender.com/bootcamp/getPlaceOrder");
