          ...
          {filteredCourses?.map((course) => (
            ...
            <div key={course?._id} className="flex flex-col justify-between bg-white rounded-lg shadow-lg overflow-hidden p-4 border border-gray-200" >
              ...
              <div className="flex flex-col flex-grow font-garet" >
                <div className="font-medium stroke-2 text-xl mb-2 text-center font-sans" onClick={() => goToDescriptionPage(course?.courseName)}>{course?.courseName}</div>
                ...
                <div className="flex justify-between items-center mt-auto">
                  ...
                  <span className="text-base font-medium text-[#182073] flex items-center" onClick={() => goToDescriptionPage(course?.courseName)}>More Info</span>
                </div>
              </div>
