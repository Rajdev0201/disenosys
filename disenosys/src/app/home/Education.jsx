    ...
    <div className="w-full mt-6 bg-red-800">
      <div className="bg-edu p-12 lg:p-40 xl:p-44">
        <div className="flex flex-col">
          ...
          <Link href="/scholarship" class="relative bg-[#4b48ff] font-garet w-48 lg:w-64  text-white font-medium text-lg lg:text-2xl px-4 py-[0.35em] pl-5 h-[2.8em] rounded-[0.9em] flex items-center overflow-hidden cursor-pointer shadow-[inset_0_0_1.6em_-0.6em_#714da6] group">
