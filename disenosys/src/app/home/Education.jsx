    ...
    <div className="w-full mt-0 lg:mt-8">
      <div className="bg-edu p-12 lg:p-44">
        <div className="flex flex-col">
          ...
          <button className="w-44 lg:w-80 bg-white  hover:bg-blue-200 text-sm lg:text-lg font-garet flex justify-center items-center gap-2 text-[#0d1039] rounded-md shadow-inner px-2 py-4">APPLY FOR A SCHOLARSHIP
