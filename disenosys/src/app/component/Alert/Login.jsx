...
const LoginAlert = () => {
  ...
  const handleForgotshow = async (e) => {
    ...
    try{
    const res = await axios.post("https://disenosys-dkhj.onrender.com/api/v1/user/forgotPassword", {
      userEmail: userMail,
    });
    if(res.data.success){
  ...
  return (
    <div className="fixed inset-x-0 -top-10  mt-0 flex justify-center z-50 font-garet">
      <Transition
        show={showAlert}
      ...
      >
        ...
        >
            ...
            forgotshow ? (
                ...
                <div className="container mx-auto pt-5">
                  ...
                  <form onSubmit={handleSignin} className="p-6">
                    <input
                      ...
                      className="w-full border-2 p-2 text-[#0d1039] border-gray-400 bg-gray-200 rounded outline-none focus:border-[#182073] transition-colors"
                    />
                    <input
                      type="password"
                      id="password"
                      placeholder="Enter Password"
                      className="w-full border-2 p-2 mt-2 text-[#0d1039] border-gray-400 bg-gray-200 rounded outline-none focus:border-[#182073] transition-colors"
                    />
                    <div className="flex justify-end">
                      <button
                        type="submit"
                        className="bg-[#0d1039] w-28 mt-3 p-2 text-xl font-medium text-white flex items-center justify-center rounded hover:bg-blue-600"
                      >
                        Continue
                      </button>
                    </div>
                    <div className="flex justify-end">
                      <h1
                        className=" text-base mt-1 font-light text-[#0d1039] mb-6 hover:text-blue-300 hover:cursor-pointer"
                        onClick={handleLogin}
                      >
              ...
              <>
                <div className="container mx-auto">
                  ...
                  <form onSubmit={handleForgotshow}>
                    <input
                      type="email"
                      id="userEmail"
                    ...
                    <button
                      type="submit"
                      className="bg-blue-400  w-full p-4 text-xl font-medium text-white rounded-md"
                    >
                      Get New Password
                    </button>
                    <button
                      type="button"
                      className="bg-red-500 w-full p-4 mt-2 mb-8 text-xl font-medium text-white rounded-md"
              ...
              <div className="container mx-auto pt-5 ">
                ...
                >
                  ...
                  <input
                    ...
                    className="w-full border-2 p-2 text-[#0d1039] border-gray-400 mt-2 bg-gray-200 rounded outline-none focus:border-[#182073] transition-colors"
                  />
                  <input
                    type="password"
                    placeholder="Enter Password"
          ...
          <div className="space-y-4 w-full max-w-xs mx-auto p-5">
            ...
            <button className="w-full flex items-center justify-center  text-[#0d1039] border border-gray-300 rounded-lg px-4 py-2 shadow-sm">
      ...
      <path fill="#EA4335" d="M44.5 20H24v8.5h11.7c-.5 2.5-1.9 4.6-3.7 6.1l6.3 6.3C41.3 37.3 44 31.1 44 24c0-1.3-.1-2.7-.5-4z"/>
            ...
            <button className="w-full flex items-center justify-center  text-[#0d1039] border border-gray-300 rounded-lg px-4 py-2 shadow-sm">
              ...
              <LinkedInLogin
                ...
                err="linkedin OAuth error please open new tab"
              />
            </button>
