            ...
            <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div class="max-w-2xl mx-auto text-center">
                    <h1 className='font-bold font-poppins text-[#182073] text-xl lg:text-5xl'>
                        Our <span className=''>C</span>ourses
                    </h1>
                ...
                <div class="grid max-w-3xl grid-cols-1 gap-6 mx-auto mt-8 sm:mt-16 sm:grid-cols-2">
                    ...
                    <div class="group duration-500  hover:-rotate-0 hover:skew-x-1 skew-x-0 hover:-translate-x-6  hover:-translate-y-12">
                        <div class="group-hover:duration-400 relative rounded-2xl w-64 mx-auto h-36 bg-[#182073] text-gray-50 flex flex-col justify-center items-center gap-1 before:-skew-x-12  before:rounded-2xl  before:absolute before:content['']  before:bg-neutral-700 before:right-3 before:top-0 before:w-64 before:h-32 before:-z-10">
                            <span class="text-5xl font-bold text-white">Online</span>
                            <p class="text-white text-base font-bold">- Course -</p>
                        </div>
                    ...
                    <div class="group duration-500  hover:-rotate-0 hover:skew-x-1 skew-x-0 hover:translate-x-6  hover:translate-y-12">
                        <div class="group-hover:duration-400 relative rounded-2xl w-64 mx-auto h-36 bg-[#182073] text-gray-50 flex flex-col justify-center items-center gap-1 before:-skew-x-12  before:rounded-2xl  before:absolute before:content['']  before:bg-neutral-700 before:right-3 before:top-0 before:w-64 before:h-32 before:-z-10">
                            <span class="text-5xl text-white font-bold">Recorded</span>
                            <p class="text-white text-base font-bold">- Course -</p>
                        </div>
