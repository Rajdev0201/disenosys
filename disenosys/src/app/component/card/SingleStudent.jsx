...
const [showCertificate, setShowCertificate] = useState(false);
  ...
  const generateSinglePDF = async (id, name, course, from, to, award, email) => {
  ...
  <div className="flex items-center mt-2 space-x-6">
    <span className="w-[400px] text-lg font-bold font-poppins text-[#182073]">Course Name:</span>
    <input
      type="text"
      name="course"
  ...
  <div className="flex items-center mt-2 space-x-6">
    <span className="w-[400px] text-lg font-bold font-poppins text-[#182073]">From:</span>
    <input
      type="date"
      name="from"
  ...
  <div className="flex items-center mt-2 space-x-6">
    <span className="w-[400px] text-lg font-bold font-poppins text-[#182073]">To:</span>
    <input
      type="date"
      name="to"
  ...
  <div className="flex items-center mt-2 space-x-6">
    <span className="w-[400px] text-lg font-bold font-poppins text-[#182073]">Awarded Date:</span>
    <input
      type="date"
      name="award"
    ...
    <div className="ml-8 text-center flex flex-col items-center">
      ...
      <p className="text-6xl font-medium font-berlin text-gray-700 mr-2 ml-16">of Internship</p>
              ...
              <p className="text-3xl mt-8  font-berlin font-light text-gray-800 ml-52 w-[480px]">
                ...
                <p className="text-md mt-4 text-gray-700 ml-52 w-[480px]">has completed the<span className="font-semibold"> {singleStudent.course}</span> at Diseñosys from<span className="font-semibold"> {formattedFromDate} </span> to <span className="font-semibold">{formattedToDate}</span>.
                </p>
                ...
                <p className="text-md mt-4 text-gray-700 ml-52 w-[480px]">
                  Awarded on{" "}
                  <span className="font-semibold">{formattedAward}</span>
                </p>
              </div>
