...
export const About = () => {
  return (
    <div className="fluid about p-8 mt-16 h-full font-garet">
    <div className="px-12 py-56">
      <h1 className="text-white text-5xl font-bold text-end -mt-12">About Us</h1>
      {/* <p className="w-full md:w-2/4 text-white  font-medium text-xl text-start mt-24">
